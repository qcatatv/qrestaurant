  ...
  return (
    <main className="min-h-screen">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Cu o tradiție în arta culinară și o pasiune pentru inovație, qRestaurant 
                vă oferă o experiență gastronomică de neuitat. Bucătarii noștri talentați 
                combină ingrediente proaspete și tehnici moderne pentru a crea preparate 
                care încântă toate simțurile.
              </p>
              <p className="text-gray-600 mb-8">
                Ambientul nostru elegant și atmosfera primitoare fac din qRestaurant 
                locul perfect pentru orice ocazie specială sau o simplă ieșire în oraș.
              </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12">Specialitățile Noastre</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-lg">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2">Somon în crustă de ierburi</h3>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-lg">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2">Risotto cu trufe negre</h3>
                <p className="text-gray-600 mb-4">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-600">Strada Exemplu nr. 123, București</span>
                </div>
                <div className="flex items-center">
                  <svg className="w-6 h-6 text-gray-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" 
